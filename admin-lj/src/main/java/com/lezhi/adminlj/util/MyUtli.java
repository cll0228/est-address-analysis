 ...
 */
public class MyUtli {
    public static List<ShDistrict> changData(List<ShDistrict> shDistricts, List<DataList> dataLists) {
        if (null == dataLists) {
            return shDistricts;
        }
        for (ShDistrict district : shDistricts) {
            for (DataList list : dataLists) {
                if (list.getDataId().equals(district.getDistrictId().toString())) {
    ...
    public static List<Town> changData1(List<Town> shDistricts, List<DataList> dataLists) {
        if (null == dataLists) {
            return shDistricts;
        }
    ...
    public static List<Neighborhood> changData2(List<Neighborhood> shDistricts, List<DataList> dataLists) {
        if (null == dataLists) {
            return shDistricts;
        }
        for (Neighborhood district : shDistricts) {
            for (DataList list : dataLists) {
                if (list.getDataId().equals(district.getNeighborhoodId().toString())) {
                    district.setHdUserNum(list.getHouseholds());
                    continue;
                }
            }
