		...
		<div id="lianjia">
			...
			<div class="map-content">
				...
				<div class="map-wrapper">
					...
					<ditie-map-component v-ref:ditiemapcomponent house-type="ershoufang" v-if="searchParams.siteType === 'ditie'" :is-full-screen="isShowLeft"></ditie-map-component>
					<map-component v-ref:mapcomponent house-type="ershoufang" v-if="searchParams.siteType === 'quyu'" :is-full-screen="isShowLeft"></map-component>
				</div>
				</div>
			</div>
		</div>
