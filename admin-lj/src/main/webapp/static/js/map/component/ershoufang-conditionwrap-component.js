...
Vue.component('ershoufang-conditionwrap-component', {
    ...
    template: '<single-condition-component :datasource="conditionMap[\'a\']" key="a" alias="目标用户数" gahrefval="sale-price-nolimit" class="gio_price" style="margin-left: 15px;"></single-condition-component>\
                <single-condition-component :datasource="conditionMap[\'l\']" key="l" alias="小区总户数" gahrefval="area-nolimit" class="gio_area"></single-condition-component>\
