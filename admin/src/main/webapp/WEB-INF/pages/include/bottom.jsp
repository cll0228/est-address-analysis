...
<script src="${ctx}/static/assets/global/plugins/bootstrap-hover-dropdown/bootstrap-hover-dropdown.min.js"
...
<script src="${ctx}/static/assets/global/scripts/form-validation.js" type="text/javascript"></script>
...
<script src="${ctx}/static/assets/global/plugins/select2/js/select2.full.min.js" type="text/javascript"></script>
        <script src="${ctx}/static/assets/global/plugins/jquery-validation/js/jquery.validate.js" type="text/javascript"></script>
        <script src="${ctx}/static/assets/global/plugins/jquery-validation/js/additional-methods.js" type="text/javascript"></script>
