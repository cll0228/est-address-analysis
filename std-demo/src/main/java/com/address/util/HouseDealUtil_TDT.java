 ...
 */
public class HouseDealUtil_TDT {
    public static void main(String[] args) {
        ...
        List<HouseDeal> dealList = stdMapper.selectTdtAddress();
        ...
        for (HouseDeal deal : dealList) {
            ...
            result.setAddress(deal.getAddress());
            result.setResidence(param.getRoadLane());
            result.setBuilding(param.getBuilding());
            System.out.println(result);
//            stdMapper.updateTdtResult(result);
