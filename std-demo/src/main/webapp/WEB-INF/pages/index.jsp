...
<div style="height: 800px;">
    <div class="form-group">
        ...
        <div class="input-group input-group-lg">
            <input id="in" type="text" class="form-control" placeholder="请输入要标准化的地址" value="文化花园">
...
<script type="text/javascript">
    ...
    function initMap() {
        //加载地图
        var map_center_lon = 121.464427;
        var map_center_lan = 31.228894;
    ...
    function initResidenceBoundary(name) {
